...
type MenuListReq struct {
	g.Meta `path:"rabc_menu/list"  tags:"系统管理员" method:"get" description:"系统管理员列表"`
...
type MenuAddReq struct {
	g.Meta `path:"rabc_menu/add"  tags:"系统管理员" method:"post" description:"添加系统管理员"`
...
type MenuEditReq struct {
	g.Meta `path:"rabc_menu/edit"  tags:"系统管理员" method:"post" description:"编辑系统管理员"`
