...
type AdminListReq struct {
	g.Meta   `path:"rabc_admin/list"  tags:"系统管理员" method:"get" description:"系统管理员列表"`
...
type AdminListRes struct {
	...
	List   []entity.MuRabcAdmin `json:"list" description:"列表数据"`
}

type AdminAddReq struct {
	g.Meta          `path:"rabc_admin/add"  tags:"系统管理员" method:"post" description:"添加系统管理员"`
...
type AdminEditReq struct {
	g.Meta   `path:"rabc_admin/edit"  tags:"系统管理员" method:"post" description:"编辑系统管理员"`
...
type AdminLoginReq struct {
	g.Meta   `path:"rabc_admin/login"  tags:"系统管理员" method:"post" description:"编辑系统管理员"`
...
type AdminLoginRes struct {
	...
	AdminInfo  entity.MuRabcAdmin     `json:"admin_info" description:"用户信息"`
	Menus      []setting.MenuListItem `json:"menus"`
	UniqueAuth []string               `json:"unique_auth"`
}
type AdminLogoutReq struct {
	g.Meta `path:"rabc_admin/logout"  tags:"系统管理员" method:"get" description:"编辑系统管理员"`
}
